          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
				  <textarea name="location" rows="5" placeholder="<?php echo $entry_location; ?>" id="input-location" class="form-control"><?php echo $location; ?></textarea>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <?php } ?>
                    <input type="text" class="form-control product_option_price" placeholder="<?php echo $entry_price; ?>" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price]" value="<?php echo $product_option_value['price']; ?>" size="5" /></td>
